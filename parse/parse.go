...
yydefault:
	...
	case 9:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line parse/parse.y:54
		{
			yyVAL.text = exprText(yy.t)
		}
	case 10:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line parse/parse.y:58
		{
			yyVAL.num = yy.i
		}
	case 12:
