...
yydefault:
	...
	case 3:
		...
		//line agent/config/parse.y:41
		{
			yyVAL.b = true
		}
	case 4:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:42
		{
			yyVAL.b = true
		}
	case 5:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:43
		{
			yyVAL.b = false
		}
	case 6:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:44
		{
			yyVAL.b = false
		}
	case 7:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line agent/config/parse.y:45
		{
			yyVAL.b = true
		}
	case 8:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:49
		{
			yyVAL.text = string(yy.t)
		}
	case 9:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:50
		{
			yyVAL.text = string(yy.t)
		}
	case 10:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:51
		{
			yyVAL.text = exprText(yy.t)
		}
	case 11:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:55
		{
			yyVAL.num = yy.i
		}
	case 12:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line agent/config/parse.y:56
		{
			yyVAL.num = yyDollar[2].num
		}
	case 13:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line agent/config/parse.y:57
		{
			yyVAL.num = yyDollar[1].num * yyDollar[3].num
		}
	case 14:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line agent/config/parse.y:58
		{
			yyVAL.num = yyDollar[1].num + yyDollar[3].num
		}
	case 15:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line agent/config/parse.y:59
		{
			yyVAL.num = int(uint(yyDollar[1].num) << uint(yyDollar[4].num))
		}
	case 16:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line agent/config/parse.y:60
		{
			yyVAL.num = int(uint(yyDollar[1].num) >> uint(yyDollar[4].num))
		}
	case 18:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line agent/config/parse.y:65
		{
			// end
	...
	case 19:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:78
		{
			// begin
			conf = &Agent{Name: "agent"}
		}
	case 22:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:85
		{
			conf.Disabled = yyDollar[2].b
		}
	case 23:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:86
		{
			conf.Host = yyDollar[2].text
		}
	case 24:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line agent/config/parse.y:87
		{
			conf.Debug = 1
		}
	case 25:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:88
		{
			conf.Debug = yyDollar[2].num
		}
	case 26:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:89
		{
			yy_ss[yyDollar[1].text] = fmt.Sprintf("%d", yyDollar[2].num)
		}
	case 27:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:90
		{
			yy_ss[yyDollar[1].text] = fmt.Sprintf("%v", yyDollar[2].b)
		}
	case 28:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:91
		{
			yy.include(yyDollar[2].text)
		}
	case 29:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line agent/config/parse.y:92
		{
			yy_ss[yyDollar[1].text] = yyDollar[2].text
		}
	case 30:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line agent/config/parse.y:93
		{
