...
var (
	...
	ModuleMap = map[string]map[string]string{
		...
		/*
			...
			"transfer": map[string]string{
				...
				transfer.C_JUDGE_CONNTIMEOUT:      "int",
				...
				transfer.C_GRAPH_CONNTIMEOUT:      "int",
				...
				transfer.C_TRANSFER_CONNTIMEOUT:   "int",
	...
	/*
		"graph": map[string]string{
			...
			graph.C_GRAPH_CONNTIMEOUT:    "/yubo/falcon/graph/config/graph/connTimeout",
		...
		"transfer": map[string]string{
			...
			transfer.C_JUDGE_CONNTIMEOUT:      "/yubo/falcon/transfer/config/judge/connTimeout",
			...
			transfer.C_GRAPH_CONNTIMEOUT:      "/yubo/falcon/transfer/config/graph/connTimeout",
			...
			transfer.C_TRANSFER_CONNTIMEOUT:   "/yubo/falcon/transfer/config/transfer/connTimeout",
