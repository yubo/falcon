  ...
  <div id="content" class="main">
    <div class="form-inline" role="form">
      <div class="form-group">
        <input type="text" v-model="query" @keyup.enter="handleQuery" class="form-control" placeholder="role name">
      </div>
    ...
    <el-dialog :title="isEdit ? 'edit role' : 'add role'" v-model="editVisible" :close-on-click-modal="false">
  ...
  methods: {
    ...
    submitObj () {
      ...
      fetch({
        ...
        url: this.isEdit ? 'role/' + this.curId : 'role',
        data: this.objForm
      }).then((res) => {
