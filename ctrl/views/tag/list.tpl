    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      <div class="page-header">
        ...
        <div class="table-responsive">
          <a href="/tag/add" class="btn btn-default pull-right"><span class="glyphicon glyphicon-plus"></span>Add</a>
              ...
              <tr>
                ...
                <td>
                  <div class="pull-right">     
                    ...
                    <a href="javascript:delete_meta('tag','{{.Id}}');" class="orange" style="text-decoration:none;"><span class="glyphicon glyphicon-trash"></span> </a>
                  </div> 
                </td>
              </tr> {{end}}
            </tbody>
