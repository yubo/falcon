...
import (
	...
	"github.com/yubo/falcon/spec"
	"github.com/yubo/falcon/storage"
	"github.com/yubo/falcon/storage/index"
	"github.com/yubo/falcon/storage/proc"
	"github.com/yubo/falcon/storage/rrdtool"
	"github.com/yubo/falcon/storage/store"
)
...
func (this *Graph) Query(param cmodel.GraphQueryParam, resp *cmodel.GraphQueryResponse) error {
	...
	md5 := Md5(param.Endpoint + "/" + param.Counter)
