...
//line backend/parse/parse.y:114
...
yydefault:
	...
	case 3:
		...
		//line backend/parse/parse.y:43
		{
			yyVAL.b = true
		}
	case 4:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:44
		{
			yyVAL.b = true
		}
	case 5:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:45
		{
			yyVAL.b = false
		}
	case 6:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:46
		{
			yyVAL.b = false
		}
	case 7:
		yyDollar = yyS[yypt-0 : yypt+1]
		//line backend/parse/parse.y:47
		{
			yyVAL.b = true
		}
	case 8:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:51
		{
			yyVAL.text = string(yy.t)
		}
	case 9:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:52
		{
			yyVAL.text = exprText(yy.t)
		}
	case 10:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:56
		{
			yyVAL.num = yy.i
		}
	case 12:
		yyDollar = yyS[yypt-3 : yypt+1]
		//line backend/parse/parse.y:61
		{
			// end
	...
	case 16:
		...
		//line backend/parse/parse.y:81
		{
			conf.Disabled = yyDollar[2].b
		}
	case 18:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:83
		{
			conf.Host = yyDollar[2].text
		}
	case 19:
		yyDollar = yyS[yypt-1 : yypt+1]
		//line backend/parse/parse.y:84
		{
			conf.Debug = 1
		}
	case 20:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:85
		{
			conf.Debug = yyDollar[2].num
		}
	case 21:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:86
		{
			yy_ss[yyDollar[1].text] = fmt.Sprintf("%d", yyDollar[2].num)
		}
	case 22:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:87
		{
			yy_ss[yyDollar[1].text] = fmt.Sprintf("%v", yyDollar[2].b)
		}
	case 23:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:88
		{
			yy.include(yyDollar[2].text)
		}
	case 24:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:89
		{
			yy_ss[yyDollar[1].text] = yyDollar[2].text
		}
	case 25:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:90
		{
	...
	case 29:
		yyDollar = yyS[yypt-2 : yypt+1]
		//line backend/parse/parse.y:100
		{
			conf.Migrate.Disabled = yyDollar[2].b
		}
	case 30:
		yyDollar = yyS[yypt-4 : yypt+1]
		//line backend/parse/parse.y:101
		{
