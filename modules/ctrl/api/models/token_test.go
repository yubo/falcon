...
func testToken(t *testing.T) {
	...
	c0 := []struct {
		...
		{name: "case3", uid: user_idx["u1"], token_id: token_idx["token3"], want: []int64{}, wante: core.EACCES},
	}
	for _, c := range c0 {
	...
	cases := []struct {
		...
		//case1
		{name: "case1-1", uid: user_idx["u1"], token_id: token_idx["token1"], tid: tag_idx["a=1"], want: 0, wante: core.EACCES},
		...
		//case2
		{name: "case2-1", uid: user_idx["u1"], token_id: token_idx["token2"], tid: tag_idx["a=1"], want: 0, wante: core.EACCES},
		...
		//case3
		{name: "case3-1", uid: user_idx["u1"], token_id: token_idx["token3"], tid: tag_idx["a=1"], want: 0, wante: core.EACCES},
		{name: "case3-2", uid: user_idx["u1"], token_id: token_idx["token3"], tid: tag_idx["a=1,b=2"], want: 0, wante: core.EACCES},
		{name: "case3-3", uid: user_idx["u1"], token_id: token_idx["token3"], tid: tag_idx["a=1,b=2,c=1"], want: 0, wante: core.EACCES},
		{name: "case3-4", uid: user_idx["u1"], token_id: token_idx["token3"], tid: tag_idx["a=1,b=2,c=2"], want: 0, wante: core.EACCES},
		//case4
		{name: "case4-1", uid: user_idx["u1"], token_id: token_idx["token41"], tid: tag_idx["a=1"], want: 0, wante: core.EACCES},
		...
		{name: "case4-5", uid: user_idx["u1"], token_id: token_idx["token42"], tid: tag_idx["a=1"], want: 0, wante: core.EACCES},
